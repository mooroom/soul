      ...
      <div className="mainBox">
        <div className="p-20">
          <p>
            ...
            [소울](‘https://www.instagram.com/soul.for.only/?igshid=1n’이하
            ‘소울’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며,
            ...
            <br />
            ① [소울](‘https://www.instagram.com/soul.for.only/?igshid=1n’이하
            ‘소울’) 은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은
          ...
          <p className="ls2">
            ① 정보주체는
            소울(‘https://www.instagram.com/soul.for.only/?igshid=1n’이하 ‘소울)
          ...
          <p className="lh6 bs4">
            <strong>
              5. 개인정보의 파기<em className="emphasis">[소울]('소울')</em>
          ...
          <p className="ls2">
            소울 은 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키’를
            사용하지 않습니다.
            <br />
            <br />
          </p>
          ...
          <br />① 소울(‘https://www.instagram.com/soul.for.only/?igshid=1n’이하
          ‘소울) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
          ...
          <p className="ls2">
            ...
            직급 :대표
            <br />
            연락처 :01043134628, junee0104@naver.com, <br />※ 개인정보 보호
            담당부서로 연결됩니다.
            <br /> <br />▶ 개인정보 보호 담당부서
            <br />
            부서명 :소울팀
            ...
            담당자 :김정윤
            <br />
            연락처 :01043134628, junee0104@naver.com, <br />② 정보주체께서는
            소울(‘https://www.instagram.com/soul.for.only/?igshid=1n’이하 ‘소울)
            의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련
          ...
          <p className="lh6 bs4">
            <strong>
              9. 개인정보의 안전성 확보 조치{" "}
              <em className="emphasis">[소울]('소울')</em>은(는) 개인정보보호법
